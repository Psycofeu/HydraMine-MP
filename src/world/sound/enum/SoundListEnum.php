...
namespace pocketmine\world\sound\enum;
...
enum SoundListEnum: string {
	...
	public function send(Player $player, float $volume = 1.0, float $pitch = 0.6): void {
		SoundUtils::send($player, $this->value, $volume, $pitch);
	}
